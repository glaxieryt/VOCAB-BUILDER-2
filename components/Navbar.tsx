    ...
    <nav className="sticky top-0 z-50 h-16 glass border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        <div className="flex items-center gap-4 sm:gap-8">
          ...
          {/* Dashboard Button - Visible only on larger screens to prevent mobile overlap */}
          <Link 
            to={user ? "/dashboard" : "/auth"} 
            className="text-sm font-bold text-white hover:text-primary transition-colors hidden sm:block"
          >
            Dashboard
          </Link>
        </div>
